...
// M3 fade-through 页面过渡: 纯淡入淡出, 无位移 (避免残影)
const pageVariants: Variants = {
  initial: { opacity: 0 },
  animate: { opacity: 1, transition: { duration: 0.2, ease: EASE_STANDARD } },
...
const fadeVariants: Variants = {
  initial: { opacity: 0 },
  animate: { opacity: 1, transition: { duration: 0.2, ease: EASE_STANDARD } },
  exit: { opacity: 0, transition: { duration: 0.12, ease: EASE_ACCELERATE } },
}

const scaleVariants: Variants = {
  initial: { opacity: 0, scale: 0.98 },
  animate: { opacity: 1, scale: 1, transition: { duration: 0.2, ease: EASE_DECELERATE } },
  exit: { opacity: 0, scale: 0.98, transition: { duration: 0.12, ease: EASE_ACCELERATE } },
}
